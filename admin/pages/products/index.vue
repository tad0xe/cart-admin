...
export default {
  async asyncData({ $axios }) {
    try {
      let categories = await $axios.$get('https://taad.herokuapp.com/api/categories')
      let owners = await $axios.$get('https://taad.herokuapp.com/api/owners')
  ...
  methods: {
    ...
    async onAddProduct() {
      ...
      const response = await axios
        .post('https://taad.herokuapp.com/api/products', data)
        .then(() => {
